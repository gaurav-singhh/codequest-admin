...
const {
  FullProblemDefinitionParser,
} = require("./FullProblemDefinitionGenerator");
...
function generateBoilerplate(problemPath) {
  ...
  try {
    ...
    console.log(
      `✅ Boilerplate generated successfully for ${path.basename(problemPath)}`
    );
    return true;
  } catch (error) {
...
if (require.main === module) {
  ...
  if (!problemPath) {
    ...
    console.error(
      "Example: node index.js ../../problem-submissions/new-problem"
    );
    process.exit(1);
  }
